...
export default function CartPage() {
  ...
  return (
    ...
    >
      <header className="flex justify-between items-center p-4 border-b border-white-buttons">
      ...
      <div className=" pr-6 pl-6 max-w-4xl min-h-screen flex gap-6">
        {/* Lista de Produtos */}
        ...
        {/* Seção de Pagamento */}
        <div className="md:absolute md:right-0 md:bottom-0 md:top-20 w-[620px] bg-gradient-to-b from-black to-light-black p-6 rounded-lg shadow-lg text-white">
